        ...
        <a-col :span="12">
          <a-card class="card" title="" :bordered="false">
            <div style="display: flex; justify-content: center">
              <a-image
                :width="420"
                src="https://file03.up71.com/File/CorpProductImages/2017/10/20/0_roybelt_4534_2049427_20171020090351.jpg"
              ></a-image>
            </div>
        ...
        <a-col :span="6">
          <a-card class="card" title="" :bordered="false">
            <a-form>
              ...
              <!-- </a-form-item> -->
              <a-form-item label="输送速度">
                <!-- {{ "200米" }} -->
                <a-input-number value="15"></a-input-number>
              </a-form-item>
              <!-- <a-form-item label="破碎粒度">
                {{ "已开" }}
