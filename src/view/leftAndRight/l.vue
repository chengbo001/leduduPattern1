        ...
        <a-col :span="12">
          <a-card class="card" title="" :bordered="false">
            <div style="display: flex; justify-content: center">
              <a-image
                :width="420"
                src="https://img2.912688.com/o_1d7k1sdi7glpelp1smjhos1kvu7.jpg?imageView2/2/w/1920#"
              ></a-image>
            </div>
        ...
        <a-col :span="6">
          <a-card class="card" title="" :bordered="false">
            <a-form>
              ...
              <!-- </a-form-item> -->
              <a-form-item label="装载速度">
                <!-- {{ "200米" }} -->
                <a-input-number value="10"></a-input-number>
              </a-form-item>
              <a-form-item label="装载料位">
                <!-- {{ "已开" }} -->
                <a-input-number value="50"></a-input-number>
              </a-form-item>
              <a-form-item label="">
                <!-- {{ "充足" }} -->
                <a-space>
